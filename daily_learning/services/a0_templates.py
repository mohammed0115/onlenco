...
A0_TOPICS: tuple[A0Topic, ...] = (
    ...
    _build_lesson(
        ...
        encouragement_ar="عمل قوي! قلت اليوم ما تقوم به.",
    ),
    _build_lesson(
        slug="u2_age",
        unit=UNIT_2_ABOUT_ME,
    ...
    _build_lesson(
        ...
        quiz_correct="like",
        quiz_explanation_en="After \"I\", say: like.",
        quiz_explanation_ar="بعد \"I\" قل: like.",
    ...
    _build_lesson(
        ...
        quiz_correct="wake",
        quiz_explanation_en="After I, say: wake up.",
        quiz_explanation_ar="بعد I قل: wake up.",
    ...
    _build_lesson(
        ...
        quiz_correct="eat",
        quiz_explanation_en="After I, say: eat.",
        quiz_explanation_ar="بعد I قل: eat.",
    ...
    _build_lesson(
        ...
        quiz_correct="drink",
        quiz_explanation_en="After I, say: drink.",
        quiz_explanation_ar="بعد I قل: drink.",
    ...
    _build_lesson(
        ...
        quiz_correct="go",
        quiz_explanation_en="After I, say: go.",
        quiz_explanation_ar="بعد I قل: go.",
    ...
    _build_lesson(
        ...
        encouragement_en="Nice! You used a new action word today.",
        encouragement_ar="جميل! قلت كلمة حركة جديدة.",
    ),
    _build_lesson(
        slug="u7_sister",
        unit=UNIT_2_ABOUT_ME,
        ...
        quiz_correct="kind",
        quiz_explanation_en="After \"is\", say: kind.",
        quiz_explanation_ar="بعد \"is\" قل: kind.",
    ...
    _build_lesson(
        ...
        quiz_correct="love",
        quiz_explanation_en="After I, say: love.",
        quiz_explanation_ar="بعد I قل: love.",
    ...
    _build_lesson(
        ...
        quiz_correct="sleep",
        quiz_explanation_en="After I, say: sleep.",
        quiz_explanation_ar="بعد I قل: sleep.",
    ...
    _build_lesson(
        ...
        encouragement_en="Two useful action words today.",
        encouragement_ar="كلمتان مفيدتان للحركة اليوم.",
    ),
    _build_lesson(
        slug="u10_speak",
        unit=UNIT_4_SIMPLE_SENTENCES,
    ...
    _build_lesson(
        ...
        encouragement_ar="هذا بالضبط ما تقوم به الآن!",
    ),
    ...
    _build_lesson(
        ...
        description_ar="قل اسمك وبلدك في مرّة واحدة.",
    ...
    _build_lesson(
        ...
        description_ar="اجمع ثلاثة أعمال صغيرة بـ \"and\".",
        ...
        quiz_explanation_ar="\"and\" تربط آخر عمل؛ والفواصل تربط البقية.",
    ...
    _build_lesson(
        ...
        encouragement_en="A new small word: \"we\". Strong.",
        encouragement_ar="كلمة صغيرة جديدة: \"we\". قوي.",
    ),
    _build_lesson(
        ...
        quiz_correct="ready",
        quiz_explanation_en="After \"am\", say: ready.",
        quiz_explanation_ar="بعد \"am\" قل: ready.",
    ...
    _build_lesson(
        ...
        encouragement_en="A new small word: he. Strong.",
        encouragement_ar="كلمة صغيرة جديدة: he. قوي.",
    ),
    ...
    _build_lesson(
        ...
        quiz_correct="doctor",
        quiz_explanation_en="Say: a doctor.",
        quiz_explanation_ar="قل: a doctor.",
    ...
    _build_lesson(
        ...
        encouragement_ar="ثلاث مهن! كلمات قوية.",
    ),
